...
这是一个可直接部署到 GitHub Pages 的静态网页，收录 2010—2026 年法学、非法学刑法与民法客观题，按题目关联众合 2027《背诵一本通》《精讲一本通》的纸质书印刷页。

## 当前口径

- 刑法 675 道、民法 680 道，共 1355 道；其中法学 505 道、非法学 850 道。
- 2025、2026 年两类试卷均已收录。
- 一道题允许关联多个罪名或知识点；民法只使用《背诵一本通》中有编号、有标题的知识点。
...
`miniprogram/` 是不依赖后端的原生微信小程序版本，保留搜索、多项筛选、双类别试卷与教材印刷页码展示。
