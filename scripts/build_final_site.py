...
.hero-top{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.hero-top h1{margin:0 0 6px}.about-toggle{flex:none;border:1px solid #c7d8f6;border-radius:8px;background:#fff;color:#2357a6;padding:5px 9px;font:inherit;font-size:12px;font-weight:650;cursor:pointer}.about-panel{margin-top:8px;padding:9px 10px;border:1px solid #d9e5fa;border-radius:9px;background:#f8fbff;color:#4a5c78;font-size:12px}.about-panel p{margin:3px 0}.back-to-top{display:grid;place-items:center;width:48px;height:48px;min-width:0;position:fixed;right:16px;bottom:20px;z-index:30;border:1px solid #9dbbf2;border-radius:50%;background:rgba(255,255,255,.96);box-shadow:0 3px 12px rgba(35,87,166,.18);color:#17458a;font:600 9px/1.2 inherit;cursor:pointer}.back-to-top[hidden]{display:none!important}.back-to-top span{display:block;white-space:nowrap;text-align:center}.back-to-top.armed{border-color:var(--blue);background:var(--blue);color:#fff}
</style>
</head>
