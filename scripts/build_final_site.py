...
.hero-top{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.hero-top h1{margin:0 0 6px}.about-toggle{flex:none;border:1px solid #c7d8f6;border-radius:8px;background:#fff;color:#2357a6;padding:5px 9px;font:inherit;font-size:12px;font-weight:650;cursor:pointer}.about-panel{margin-top:8px;padding:9px 10px;border:1px solid #d9e5fa;border-radius:9px;background:#f8fbff;color:#4a5c78;font-size:12px}.about-panel p{margin:3px 0}
</style>
</head>
